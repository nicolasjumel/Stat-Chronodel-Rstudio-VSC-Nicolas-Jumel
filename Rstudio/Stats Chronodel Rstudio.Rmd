...
The project is available on GitHub at this link: https://github.com/nicolasjumel/Stat-Chronodel-Rstudio-VSC-Nicolas-Jumel
...
- **Input**: cleaned dataset stored in the `Data` folder.
- **output**: a cross-tabulation table showing the counts of success and failure for *DOTWB* and *MOTYB*, along with calculated concordance and discordance rates saved as (cross_tab_dotwb_motyb.csv) in the `Results` folder.
